...
ResultSet rs = null;
	try
	{
		...
		out.println("Driver is Loaded");
   	    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/nietdb","root","aarav"); 
		out.println("<br><br>"); 
		out.println( "Connection is Available");
   		stmt=con.createStatement();  
   		stmt.executeUpdate("Insert into aarav value(6,'E','South Delhi','1234')");
		rs=stmt.executeQuery("select * from aarav");
%>
